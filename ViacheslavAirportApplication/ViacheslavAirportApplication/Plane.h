...
public:
	...
	Plane(String^ id, String^ name, String^ modelName, String^ color, String^ type, int places, int availablePlaces, int speed, bool isAvailable, DateTime^ arrival, DateTime^ departure) {
		this->id = id;
		this->name = name;
		this->modelName = modelName;
		this->color = color;
